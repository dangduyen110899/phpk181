<?php
    ...
    if(isset($_POST['sbm'])){
        ...
        if($file_error > 0){
            ...
            move_uploaded_file($tmp_name, 'dulieu/'.$fileupload);
            //update json
            $arr_json[$book]=$fileupload;
...
<body>
<!-- taoj file json, khai bao key ; ten sach, value ten file,goi json trong index, chuyen sag mang, foreach, echo toan boj -->
                    ...
                    <div class="body table-responsive">
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                <?php
                                    $a = 1;
                                    foreach($arr_json as $book => $fileupload){
                                  
                                ?>
                                <tr class="active">
                                    <th scope="row"> <?php echo $a; ?></th>
                                    <td><?php echo $book; ?></td>
                                    <td class="text-center"><a href="read.php?fileupload=<?php echo $fileupload ?>"><i class="fas fa-eye"></i></a></td>
                                    <td class="text-center"><a href="download.php?fileupload=<?php echo $fileupload ?>"><i class="fa fa-download"></i></a></td>
                                </tr>
                                <?php  $a ++; } ?>
                            </tbody>
                        </table>
      ...
      <div class="modal-body">
       ...
       <form action="#" method="POST" enctype="multipart/form-data">
         ...
         <input type="text" class="form-control"  name="book">
          ...
          <button id="add-book" name="sbm" type="submit" class="btn btn-primary">Thêm sách</button>
        </form> 
