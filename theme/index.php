<?php
    ...
    //chuyển json về mảng
        $lang_json = json_decode($data_json,true);
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <?php echo $lang_json['title'] ?>
                            <small><?php  echo $lang_json['description']?></small>
                        </h2>
                    </div>
                    <div class="body table-responsive">
                        <table class="table table-condensed">
                            <thead>
                                <tr>
                                    <th width="10%">#</th>
                                    <th width="60%"><?php  echo $lang_json['name']?></th>
                                    <th width="15%" class="text-center"><?php  echo $lang_json['preview']?></th>
                                    <th width="15%" class="text-center"><?php  echo $lang_json['download']?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="active">
