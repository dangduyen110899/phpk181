<?php
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "UPDATE product
        SET prd_name='$prd_name', prd_price='$prd_price', prd_warranty='$prd_warranty', prd_accessories='$prd_accessories', 
        prd_promotion='$prd_promotion', prd_new='$prd_new', prd_image='$prd_image', cat_id='$cat_id', prd_status='$prd_status', 
        prd_featured='$prd_featured', prd_details='$prd_details' WHERE prd_id=$prd_id";
        $query = mysqli_query($connect, $sql);
        //chuyển hướng trang 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="prd_status" class="form-control">
                                        <option <?php  if($row['prd_status'] == 1) echo "Selected"; ?> >Còn hàng</option>
                                        <option <?php  if($row['prd_status'] == 0) echo "Selected"; ?> >Hết hàng</option>
                                    </select>
                                </div>
